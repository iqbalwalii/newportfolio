    ...
    >
      <div className="max-w-screen-lg p-4 mx-auto flex flex-col justify-center w-full h-full text-lg">
        ...
        <p className="mb-4 py-6">
          As a seasoned IT professional with a robust skill set, I specialize in
          creating immersive and user-centric web experiences through my
          expertise in frontend development. With a foundation in software
          architecture and development, I bring a unique blend of technical
          prowess and creative flair to every project.
        </p>
